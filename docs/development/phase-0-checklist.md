...
- [x] Platform/model boundary captured in an ADR.
- [x] No Trade semantics captured in an ADR and stable reason codes.
- [x] Generic model plugin contract and registry exist.
- [x] Core formulas and rounding rules are executable and tested.
- [x] Rules and thresholds are versioned outside business logic.
